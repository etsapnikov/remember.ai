...
class Recorder(private val context: Context) {
    ...
    companion object {
        ...
        /**
         * То же, но когда человек **отвечает на заданный вопрос** (Р-21.2).
         *
         * Три секунды рассчитаны на комок: человек нажал клавишу и собирается с
         * мыслями. Ответ устроен иначе — вопрос уже задан, и ответ бывает
         * короче трёх секунд целиком: «да, к воскресенью». Порог не набирался,
         * тишина не копилась, и запись висела до потолка в полторы минуты —
         * останавливать приходилось руками.
         *
         * Случайных нажатий тут не бывает: экран открыт из карточки, вопросом.
         */
        const val SPEECH_BEFORE_AUTOSTOP_ANSWER_MS = 800L
